...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Add Formateur</h4>

<div class="row">
  <div class="col-xxl">
    <div class="card mb-4">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h5 class="mb-0">Add Formateur</h5>
      </div>
      <div class="card-body">
        <form action="{{ route("store.formateurs")}}" method="POST">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                ...
                <input name="nom" type="text" class="form-control" id="basic-icon-default-fullname" placeholder="hathout" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <div class="input-group input-group-merge">
                <span id="basic-icon-default-fullname2" class="input-group-text"><i class="bx bx-user"></i></span>
                <input name="prenom" type="text" class="form-control" id="basic-icon-default-fullname" placeholder="Mohammed Taha" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
              </div>
              @error('prenom')
                {{$message}}
              @enderror
